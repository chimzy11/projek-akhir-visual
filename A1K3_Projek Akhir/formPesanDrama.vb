...
Public Class formPesanDrama
    ...
    Sub PilihanKursi()
        ...
        If RD.Read() Then
            ...
            Dim fileMusikal As String = "Drama_" + PopUpDataJadwalDrama.cJudul.Text.Replace(" ", "_") + ".txt"
        ...
        End If
    End Sub
    Private Sub formPesanDrama_Load(sender As Object, e As EventArgs) Handles MyBase.Load
