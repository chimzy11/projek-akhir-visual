...
Public Class formPembayaranKomedi
    ...
    Sub Simpan()
        ...
        If Not RD.HasRows Then
            ...
            CMD.Parameters.AddWithValue("@Jumlah", formPesanKomedi.tBanyakTiket.Text)
            CMD.Parameters.AddWithValue("@Harga", formDetailKomedi.lHarga.Text)
            CMD.Parameters.AddWithValue("@TotalTransaksi", formPesanKomedi.lTotalHarga.Text)
    ...
    Private Sub bChsBuktiPembayaran_Click(sender As Object, e As EventArgs) Handles bChsBuktiPembayaran.Click
        ...
        If OpenProfil.ShowDialog() = DialogResult.OK Then
            ...
            Dim i As Integer = 1
            Dim newFileName As String = FLogin.tUsername.Text & "_komedi_" & i.ToString() & fileExtension
            ...
            While File.Exists(destinationPath)
                i += 1
                newFileName = FLogin.tUsername.Text & "_komedi_" & i.ToString() & fileExtension
    ...
    Private Sub bCetak_Click(sender As Object, e As EventArgs) Handles bCetak.Click
        ...
        Dim fileMusikal As String = "Komedi_" + formPesanKomedi.lJudul.Text.Replace(" ", "_") + ".txt"

        Using writer As New StreamWriter(fileMusikal)
            For Each checkBox As CheckBox In formPesanKomedi.Panel2.Controls.OfType(Of CheckBox)()
