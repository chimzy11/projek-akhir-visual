...
Public Class formPembayaranDrama
    Function GetSelectedSeatCount() As Integer
        Dim selectedCount As Integer = 0

        For Each control As Control In formPesanDrama.Panel2.Controls
    ...
    Sub Simpan()
        ...
        If Not RD.HasRows Then
            ...
            CMD.Parameters.AddWithValue("@Judul", formPesanDrama.lJudul.Text)
            RD = CMD.ExecuteReader()
            RD.Read()
            ...
            CMD.Parameters.AddWithValue("@Judul", formPesanDrama.lJudul.Text)
            CMD.Parameters.AddWithValue("@Genre", "Drama")
            CMD.Parameters.AddWithValue("@Jumlah", formPesanDrama.tBanyakTiket.Text)
            CMD.Parameters.AddWithValue("@Harga", formDetailDrama.lHarga.Text)
            CMD.Parameters.AddWithValue("@TotalTransaksi", formPesanDrama.lTotalHarga.Text)
    ...
    Private Sub bCetak_Click(sender As Object, e As EventArgs) Handles bCetak.Click
        ...
        Dim filedrama As String = "Drama_" + formPesanDrama.lJudul.Text.Replace(" ", "_") + ".txt"

        Using writer As New StreamWriter(filedrama)
            For Each checkBox As CheckBox In formPesanDrama.Panel2.Controls.OfType(Of CheckBox)()
