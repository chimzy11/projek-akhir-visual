...
Public Class formPesanKomedi
    ...
    Sub PilihanKursi()
        ...
        If RD.Read() Then
            ...
            Dim fileMusikal As String = "Komedi_" + PopUpDataJadwalKomedi.cJudul.Text.Replace(" ", "_") + ".txt"
        ...
        End If
    End Sub
    Private Sub formPesanKomedi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
