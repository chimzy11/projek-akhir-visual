...
Public Class formDetailKomedi
    ...
    Sub FileKomedi()
        ...
        If RD.Read() Then
            ...
            Dim filekomedi As String = "Komedi_" + PopUpDataJadwalKomedi.cJudul.Text.Replace(" ", "_") + ".txt"
            If Not File.Exists(filekomedi) Then
                Dim nama As Char = "A"c
                Dim nomorKursi As Integer = 1

                Dim writer As New StreamWriter(filekomedi)
    ...
    Sub TampilProfilJadwal()
        ...
        RD.Close()
    End Sub
    Private Sub formDetailKomedi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call KoneksiDatabase()
        Call TampilProfilJadwal()
        FileKomedi()
        Dim queryString As String = "SELECT * FROM JadwalTeater WHERE judul ='" & PopUpDataJadwalKomedi.cJudul.Text & "'"
